 ...
 * Codec information
 */
JNIEXPORT jstring Java_uiip_dji_pcapi_com_media_NativeHelper_codecinfotest(JNIEnv *env, jobject obj)
{
	char info[40000] = { 0 };
 ...
 */
JNIEXPORT jboolean Java_uiip_dji_pcapi_com_media_NativeHelper_init(JNIEnv *env, jobject obj)
{
...
int parse(JNIEnv *env, jobject obj, uint8_t* pBuff, int videosize, uint64_t pts) 
{
	...
	while (paserLength_In > 0) 
	{
		...
		if (m_pCodecPaser == NULL) {
			...
			Java_uiip_dji_pcapi_com_media_NativeHelper_init(env, obj);
		}
 ...
 */
JNIEXPORT jboolean Java_uiip_dji_pcapi_com_media_NativeHelper_parse(JNIEnv *env, jobject obj, jbyteArray pBuff, int size)
{
 ...
 * Release the ffmpeg.
 */
JNIEXPORT jboolean Java_uiip_dji_pcapi_com_media_NativeHelper_release(JNIEnv *env, jobject obj)
{
	if (m_pCodecCtx) 
	{
